...
<!--          <el-button size="mini" type="success" plain @click="showBooks(scope.row.bookList)">查看订单列表</el-button>-->
...
<!--    <el-dialog title="用户定单列表" v-model="bookVis" width="30%">-->
    ...
    <el-dialog title="提示" v-model="dialogVisible" width="30%">
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="身份证号码">
          <el-input v-model="form.identify" style="width: 80%"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
